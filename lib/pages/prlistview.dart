      ...
      children: prs
          .map((pullRequest) => ListTile(
                ...
                onTap: (){
                  ...
                  Future<List<TimelineItem>> timelines = getPRTimeline(pullRequest);
                  // display them
                  // Navigator.push(context,
                  //   MaterialPageRoute(builder: (context) => PRTimelineView(timelines, pullRequest),
                  // ));
                },
